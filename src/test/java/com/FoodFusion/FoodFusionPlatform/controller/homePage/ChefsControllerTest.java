...
public class ChefsControllerTest {
    ...
    void testAddChef() throws Exception {
        Chefs chef = new Chefs(1L, "Gordon Ramsay", "International Cuisine");
        given(com.foodFusion.foodFusionPlatform.services.homePage.ChefsService.addChef(chef)).willReturn(chef);
    ...
    void testGetAllChefs() throws Exception {
        Chefs chef = new Chefs(1L, "Gordon Ramsay", "International Cuisine");
        given(chefService.getAllChefs()).willReturn(Collections.singletonList(chef));
    ...
    void testGetChefByName() throws Exception {
        Chefs chef = new Chefs(1L, "Gordon Ramsay", "International Cuisine");
        given(chefService.getChefByName("Gordon Ramsay")).willReturn(chef);
